...
#ifndef PINEPGSDK_SWIFT_H
#define PINEPGSDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PinePGSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9PinePGSDK11AppDelegate")
...
SWIFT_CLASS("_TtC9PinePGSDK12DismissBarVC")
@interface DismissBarVC : UIViewController
@property (nonatomic, weak) IBOutlet UIView * _Nullable backgroundView;
...
SWIFT_CLASS("_TtC9PinePGSDK17DismissalAnimator")
@interface DismissalAnimator : UIPercentDrivenInteractiveTransition <UIViewControllerAnimatedTransitioning>
...
SWIFT_CLASS("_TtC9PinePGSDK28HalfSheetPresentationManager")
@interface HalfSheetPresentationManager : NSObject <UIGestureRecognizerDelegate>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (void)handleDismissingTap;
- (void)handleDismissingPan:(UIPanGestureRecognizer * _Nonnull)pan;
@end
...
@interface HalfSheetPresentationManager (SWIFT_EXTENSION(PinePGSDK)) <UIViewControllerTransitioningDelegate>
...
SWIFT_CLASS("_TtC9PinePGSDK23NVActivityIndicatorView")
...
SWIFT_CLASS("_TtC9PinePGSDK24PaymentResponseConstants")
@interface PaymentResponseConstants : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC9PinePGSDK15PinePGConstants")
@interface PinePGConstants : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC9PinePGSDK21PinePGPaymentActivity")
@interface PinePGPaymentActivity : UIViewController <UIWebViewDelegate, WKNavigationDelegate, WKUIDelegate>
@property (nonatomic, strong) IBOutlet UIBarButtonItem * _Null_unspecified canel_Icon_Nvaigation_Item;
...
SWIFT_CLASS("_TtC9PinePGSDK20PresentationAnimator")
...
SWIFT_CLASS("_TtC9PinePGSDK26PresentationViewController")
@interface PresentationViewController : UIPresentationController
...
@interface PresentationViewController (SWIFT_EXTENSION(PinePGSDK)) <UINavigationControllerDelegate>
...
SWIFT_CLASS("_TtC9PinePGSDK27ToastPresentationController")
@interface ToastPresentationController : UIPresentationController
...
SWIFT_CLASS("_TtC9PinePGSDK19ToastViewController")
@interface ToastViewController : UIViewController <UIViewControllerTransitioningDelegate>
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
...
@interface UIViewController (SWIFT_EXTENSION(PinePGSDK))
...
SWIFT_CLASS("_TtC9PinePGSDK28VerticalPanGestureRecognizer")
...
SWIFT_CLASS("_TtC9PinePGSDK14ViewController")
@interface ViewController : UIViewController <UITextFieldDelegate>
@property (nonatomic, strong) IBOutlet UIButton * _Null_unspecified submit;
@property (nonatomic, strong) IBOutlet UITextField * _Null_unspecified text_Field_2;
@property (nonatomic, strong) IBOutlet UITextField * _Null_unspecified text_Field_1;
@property (nonatomic, strong) IBOutlet UITextField * _Null_unspecified text_Field_3;
@property (nonatomic, strong) IBOutlet UITextField * _Null_unspecified text_Field_5;
@property (nonatomic, strong) IBOutlet UITextField * _Null_unspecified text_Field_6;
@property (nonatomic, strong) IBOutlet UITextField * _Null_unspecified text_Field_4;
- (void)viewDidLoad;
...
SWIFT_PROTOCOL("_TtP9PinePGSDK20iProgressHUDDelegete_")
